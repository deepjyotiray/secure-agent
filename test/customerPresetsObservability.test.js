...
function main() {
    ...
    const summary = summarizeCustomerLog([
        { intent: "customer_backend", phone: "+1", ts: 1, preview: { strategy: "backend_first", backend: "openclaw", responseGuardIssues: [] } },
        ...
        { intent: "customer_backend", phone: "+4", ts: 4, preview: { strategy: "auto", backend: "myclaw", responseGuardIssues: ["response_too_long"] } },
    ])
